        ...
        <div class='row no-gutters'>
            <div 
                ...
                <a id="box-image-holder-link" href="<?php echo get_permalink($result->products[0]->get_id() ); ?>">
                    <img class="watermark-so" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/img/watermark-so.png' ?>" <?php if($result->products[0]->sale_price <= 0){ echo "style='display: none;'"; }  ?> >
                    <img class="watermark" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/img/watermark.png'; ?>" <?php if($result->products[0]->sale_price > 0){ echo "style='display: none;'"; } ?> >
                </a>                    
            </div>                
